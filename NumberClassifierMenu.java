...
public class NumberClassifierMenu {
    public static void main(String[] args) {
        ...
        do {
            ...
            // Declare Switch Statement for Menu Handling
            switch (choice) {
                case 1:
                    // Case for Classify Number
            ...
            // Ask to Continue
            if (choice != 3) { // Only ask if the user did not choose to exit
                System.out.print("Do you want to return to the menu? (Y/N): ");
                input.nextLine(); // Consume newline
                userChoice = input.nextLine().toUpperCase().charAt(0);
            } else {
                userChoice = 'N'; // Set to 'N' to exit if the user chose to exit
            }
